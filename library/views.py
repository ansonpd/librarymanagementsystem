...
def viewissuedbook_view(request):
    ...
    return render(request,'library/viewissuedbook.html',{'li':li},l)
...
def contact_view(request):
    books=models.Book.objects.all()
    return render (request,'store/contact.html',{'books':books})
...
def purchase_view(request,product_id):
    purchases=Product.objects.get(id=product_id)
    return render (request,'store/order.html',{'purchases':purchases})
...
def order_view(request):
   if request.method=="POST":
        ...
        Order(name=name,email=email,phone=phone,address=address,district=district,payment_method=payment_method,transaction_id=transaction_id).save()
        return render(request,'store/sucessful.html')
 
   return render (request,'store/details.html' )

def sucessful_view(request ):  
